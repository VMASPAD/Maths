function exetedreon(){
    ...
    function Triangulo(){
        ...
        const anguleA = parseFloat(document.getElementById("anguleA").value);
        const anguleB = parseFloat(document.getElementById("anguleB").value);
        const anguleC = parseFloat(document.getElementById("anguleC").value);
...
function mostrarTexto() {
 ...
 <br>
  ...
  <br>
      ...
      <p id="resultadosAC"></p>
      <p id="resultadosAB"></p>
      <p id="resultadosABC"></p>
      <p id="resultadosACB"></p>
      <p id="resultadosBCA"></p>
